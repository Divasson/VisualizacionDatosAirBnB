...
def opcionesGlobales():
    ...
    z = {
            ...
            "Opciones desplegable Vivienda":["property_type","room_type","beds","baths","review_scores_rating"],
            "Opciones desplegable Finanzas":["price","occupancy_rate","revenue","price per unit","profitability"],
            "Barrios":{
                "Brooklyn": "#1f77b4",
                "Bronx": "#ff7f0e",
                "Staten Island":"#2ca02c",
